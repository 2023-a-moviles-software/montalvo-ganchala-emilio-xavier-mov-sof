...
class FRecyclerViewAdaptadorNombreCedula (
    private val cotexto: FRecyclerView,
    ...
    private val recyclerView: RecyclerView
        ...
        inner class MyViewHolder(view: View):RecyclerView.ViewHolder(view) {
            ...
            init {
                ...
                actionBoton=view.findViewById(R.id.btn_dar_like)
                actionBoton.setOnClickListener { anadirLike() }
            }

            fun anadirLike(){
                numeroLikes=numeroLikes+1
                likesTextView.text=numeroLikes.toString()
                cotexto.aumentarTotalLikes()
            }
        }
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
       val entrenadorActual=this.lista[position]
        ...
        holder.actionBoton.text="Like ${entrenadorActual.id} - ${entrenadorActual.nombre}"
