...
class IFirestore : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Empezar a paginar
        val botonEmpezarPaginar = findViewById<Button>(R.id.btn_fs_paginar)
        botonEmpezarPaginar.setOnClickListener { query = null;consultarCiuddades(adaptador) }
    ...
    fun consultarCiuddades(adaptador: ArrayAdapter<ICities>){
    ...
    fun guardarQuery(documentSnapshot:QuerySnapshot,
                     refCities:Query){
