...
class CIntentExplicitoParametros : AppCompatActivity() {
    ...
    fun devolverRespuesta(){
        val intetDevolverParametros= Intent()
        intetDevolverParametros.putExtra("nombreModificado","Vicente")
        intetDevolverParametros.putExtra("edadModificado",33)
        setResult(
            RESULT_OK,
            intetDevolverParametros
        )
        finish()
    }
}